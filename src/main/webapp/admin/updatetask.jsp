			...
			<div class="span9" style="padding-left: 20px;">
				...
				<div id="demo">
					<form id="updatertask" class="form-horizontal"
						action="${ baseUrl }/admin/updateitem" method="post">
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<textarea id="taskcontent" class="input-xlarge" rows="3"
										name="task.content">${task.content}</textarea>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select id="header" name="userid">
										<c:forEach var="manager" items="${ managers }">
											<c:choose>
												<c:when test="${task.exeuser.department.id == manager.department.id}">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="taskstatus" name="task.status">
										<c:if test="${task.status == '未下达'}">
											<option value="未下达" selected="selected">未下达</option>
