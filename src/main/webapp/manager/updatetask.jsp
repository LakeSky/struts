				...
				<div class="accordion" id="admin-accordion">
					<div class="accordion-group">
						...
						<div id="collapseOne" class="accordion-body in collapse">
							<div class="accordion-inner">
								<ul>
									<li><a href="#">系统提示</a></li>
									<li><a href="${ baseUrl }/manager/newpass">更改密码</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="accordion-group">
						...
						<div id="collapseFive" class="accordion-body in collapse">
							<div class="accordion-inner">
								<ul>
									<li><a href="${ baseUrl }/manager/checktask">查询分配</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="span9" style="padding-left: 20px;">
				...
				<div id="demo">
					<form id="updatertask" class="form-horizontal"
						action="${ baseUrl }/manager/updateitem" method="post">
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="header" name="userid">
										<c:forEach var="user" items="${ workers }">
											<c:choose>
												<c:when test="${task.exeuser.id == user.id}">
